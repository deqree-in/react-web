      ...
      {(context) => {
        return (
          <div className="left-side">
            ...
            <IconButton
              onClick={() => context.setActive("upload")}
              style={{ marginBottom: "30px" }}
            >
              <CloudUploadOutlined
                style={{
                  color: context.active === "upload" ? "#4255d4" : "#8a94a7",
                  transform: "scale(1.3)",
                  // paddingBottom: "45px",
                }}
              />
            ...
            <IconButton
              onClick={() => context.setActive("documents")}
              style={{ marginBottom: "30px" }}
            >
              <AssignmentOutlined
                style={{
                  color: context.active === "documents" ? "#4255d4" : "#8a94a7",
                  transform: "scale(1.3)",
                  // paddingBottom: "45px",
                }}
              />
            ...
            <IconButton onClick={() => context.setActive("notifications")}>
              <Notifications
                style={{
                  color:
                    context.active === "notifications" ? "#4255d4" : "#8a94a7",
                  transform: "scale(1.3)",
                  // paddingBottom: "45px",
                }}
              />
            ...
            <svg
              ...
              onClick={() => context.setActive("settings")}
              className={context.active === "settings" && "active"}
            >
